...
public class Config
{
    ...
    public static String[] excludedItemsModels;
	...
	public static void sync()
	{
		try
		{
            ...
            excludedItemsModels = HardcoreItemStages.config.getStringList("excludedItemsModels", "general", new String[]{"draconicevolution:energy_storage_core"}, "Item IDs that should be excluded from item stage hiding");
		} catch (Exception e)
		{
		} finally
		{
